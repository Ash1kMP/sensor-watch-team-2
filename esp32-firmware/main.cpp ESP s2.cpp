...
<!DOCTYPE html><html><head>
  ...
  server.on("/login", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", loginPage);
...
<!DOCTYPE html><html><head>
  ...
  server.on("/serverIndex", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", otaPage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
 ...
 void handleFileUpload(AsyncWebServerRequest *req, const String &filename,size_t index,uint8_t *data,size_t len,bool final)
{
 ...
 void connectivityEndpoints() {
  ...
  server.on("/connectivity", HTTP_GET, [](AsyncWebServerRequest *req) {
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", connectivityPage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
}
...
void setup() {
  ...
  server.on("/manage", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", managePage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
  server.on("/labels", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", labelsPage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
  server.on("/fs", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", fsPage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
  ...
  server.on("/", HTTP_GET, [](AsyncWebServerRequest *req){
    AsyncWebServerResponse *resp = req->beginResponse(200, "text/html; charset=utf-8", webpage);
    resp->addHeader("Cache-Control", "no-store");
    req->send(resp);
  });
